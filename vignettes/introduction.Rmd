...
This package was created to process EncirhR result data and use it for GOplot.
Therefore, you must use the version of GO DB specified below.
---
  
**__requirement packages__**  
